...
sidebar <-  dashboardSidebar(
  pickerInput("gene", "Select pharmacogene", sort(result$genes),selected = "CYP2D6",
  ...
  prettyRadioButtons("average", "Aggregating method", choices = c("median", "weighted median")),
   sidebarMenu(
                ...
                menuItem("Raw data", tabName = "raw_data",icon = icon("dna")),
...
ui <- dashboardPage(title = "Worldalleles", skin = "blue",header, sidebar, body)
