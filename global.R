...
method_text <- glue("Worldwide frequency data is gathered using genetic allele frequency data of the most important functional pharmacogenes available at https://www.pharmgkb.org. 
First, data was downloaded (accessed {result$access}) and available population information was mapped to a specific country as shown in tab 'Raw data' for each study.   
